...
(function($PS) {
  ...
  var install = function (extraArgs) {
      ...
      return Control_Bind.bind(Effect_Aff.bindAff)(Core.buildScript(Data_List_Types.foldableList)({
          ...
          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)((function () {
              ...
              throw new Error("Failed pattern match at Main (line 88, column 3 - line 95, column 13): " + [ nixBuildResult.constructor.name ]);
          })())(function () {
              return Control_Bind.bind(Effect_Aff.bindAff)(Core.runCommand({
                  ...
                  throw new Error("Failed pattern match at Main (line 97, column 3 - line 106, column 13): " + [ installResult.constructor.name ]);
              });
          });
      });
  };
  var build = function (buildStyle) {
      return function (extraArgs) {
          var buildStyleAttr = (function () {
              ...
              throw new Error("Failed pattern match at Main (line 152, column 22 - line 154, column 38): " + [ buildStyle.constructor.name ]);
          })();
          var buildCmd = ".spago2nix/build" + (function () {
              ...
              throw new Error("Failed pattern match at Main (line 149, column 29 - line 151, column 42): " + [ buildStyle.constructor.name ]);
          })();
          return Control_Bind.bind(Effect_Aff.bindAff)(Core.buildScript(Data_List_Types.foldableList)({
              attr: buildStyleAttr,
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)((function () {
                  ...
                  throw new Error("Failed pattern match at Main (line 118, column 3 - line 125, column 13): " + [ nixBuildResult.constructor.name ]);
              })())(function () {
                  return Control_Bind.bind(Effect_Aff.bindAff)(Control_Alt.alt(Effect_Aff.altAff)(Core.runDhallToJSON("(./spago.dhall).sources"))(Control_Applicative.pure(Effect_Aff.applicativeAff)("")))(function (json) {
                      return Control_Bind.bind(Effect_Aff.bindAff)((function () {
                          ...
                          throw new Error("Failed pattern match at Main (line 127, column 12 - line 135, column 14): " + [ v.constructor.name ]);
                      })())(function (globs) {
                          return Control_Bind.bind(Effect_Aff.bindAff)(Core.runCommand({
                              cmd: buildCmd,
                              args: globs
                              ...
                              throw new Error("Failed pattern match at Main (line 137, column 3 - line 146, column 13): " + [ buildResult.constructor.name ]);
                          });
                      });
                  });
              });
  ...
  var argParser = (function () {
      ...
      var mainDesc = function (sub) {
          return Options_Applicative_Builder.info(Options_Applicative_Internal_Utils.apApplyFlipped(Options_Applicative_Types.parserApply)(sub)(Options_Applicative_Extra.helper))(Data_Semigroup.append(Options_Applicative_Builder.infoModSemigroup)(Options_Applicative_Builder.fullDesc)(Options_Applicative_Builder.header("spago2nix - generate Nix derivations from packages required in a spago project, and allow for installing them and building them.")));
      };
  ...
  var main = (function () {
      ...
      return function __do() {
          var cmd = Options_Applicative_Extra.customExecParser(prefs$prime)(argParser)();
          return Effect_Aff.launchAff_((function () {
              if (cmd instanceof Generate) {
                  return Generate_1.generate(cmd.value0.maxPackagesFetchedAtOnce);
              };
              if (cmd instanceof Install) {
                  return install(cmd.value0.extraArgs);
              };
              if (cmd instanceof Build) {
                  return build(SpagoStyle.value)(cmd.value0.extraArgs);
              };
              if (cmd instanceof BuildNix) {
                  return build(NixStyle.value)(cmd.value0.extraArgs);
              };
              throw new Error("Failed pattern match at Main (line 79, column 66 - line 83, column 55): " + [ cmd.constructor.name ]);
          })())();
      };
  })();
  exports["args"] = args;
