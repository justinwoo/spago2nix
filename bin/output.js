...
(function($PS) {
  ...
  var mkJSONError = function ($91) {
      return JSONError.create(Simple_JSON_Utils.printMultipleErrors($91));
  };
  var readPackage = (function () {
      var $92 = Data_Bifunctor.lmap(Data_Either.bifunctorEither)(mkJSONError);
      var $93 = Simple_JSON.readJSON(Simple_JSON.readRecord()(Simple_JSON.readFieldsCons(new Data_Symbol.IsSymbol(function () {
          return "packageName";
      }))(Simple_JSON.readString)(Simple_JSON.readFieldsCons(new Data_Symbol.IsSymbol(function () {
          return "repo";
  ...
  var readForeignFetchResult = new Simple_JSON.ReadForeign((function () {
      ...
      var $96 = Simple_JSON.readImpl(Simple_JSON.readForeignVariant()(Simple_JSON.readVariantCons(new Data_Symbol.IsSymbol(function () {
          return "CantFetchLocal";
  ...
  var writeForeignFetchResult = new Simple_JSON.WriteForeign((function () {
      var $98 = Simple_JSON.writeImpl(Simple_JSON.writeForeignVariant()(Simple_JSON.consWriteForeignVariant(new Data_Symbol.IsSymbol(function () {
          return "CantFetchLocal";
      ...
      var $99 = Kishimen.genericSumToVariant(genericFetchResult)(Kishimen.genericSumToVariantSum(Kishimen.genericSumToVariantConstructor(new Data_Symbol.IsSymbol(function () {
          return "CantFetchLocal";
      }))()(Kishimen.genericSumToVariantArgArguments))(Kishimen.genericSumToVariantConstructor(new Data_Symbol.IsSymbol(function () {
          return "Fetched";
      }))()(Kishimen.genericSumToVariantArgArguments))()()()()(Data_Variant_Internal.variantTagsCons(Data_Variant_Internal.variantTagsNil)(new Data_Symbol.IsSymbol(function () {
