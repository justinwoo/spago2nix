...
(function($PS) {
  ...
  var writeForeignRepo = new Simple_JSON.WriteForeign(function (v) {
      ...
      throw new Error("Failed pattern match at Core (line 161, column 1 - line 163, column 84): " + [ v.constructor.name ]);
  });
  ...
  var runDhallToJSON = function (v) {
      return Effect_Aff.makeAff(function (cb) {
          return function __do() {
              ...
              var v3 = Node_ChildProcess.spawn("dhall-to-json")([  ])(Node_ChildProcess.defaultSpawnOptions)();
              var write = Node_ChildProcess.stdin(v3);
              var v4 = Node_Stream.writeString(write)(Node_Encoding.UTF8.value)(v)(Node_Stream.end(write)(Data_Monoid.mempty(Effect.monoidEffect(Data_Monoid.monoidUnit))))();
              Node_Stream.onDataString(Node_ChildProcess.stdout(v3))(Node_Encoding.UTF8.value)(function (string) {
                  return Effect_Ref.modify_(function (v5) {
                      return v5 + string;
                  })(v1);
              })();
              Node_Stream.onDataString(Node_ChildProcess.stderr(v3))(Node_Encoding.UTF8.value)(function (string) {
                  return Effect_Ref.modify_(function (v5) {
                      return v5 + string;
                  })(v2);
              })();
              Node_ChildProcess.onError(v3)(function ($108) {
                  return cb(Data_Either.Left.create(Node_ChildProcess.toStandardError($108)));
              })();
              Node_ChildProcess.onExit(v3)(function (code) {
                  if (code instanceof Node_ChildProcess.Normally && code.value0 === 0) {
                      return function __do() {
                          var v5 = Effect_Ref.read(v1)();
                          return cb(Data_Either.Right.create(v5))();
                      };
                  };
                  return function __do() {
                      var v5 = Effect_Ref.read(v2)();
                      Effect_Class_Console.error(Effect_Class.monadEffectEffect)("error running dhall-to-json:")();
                      Effect_Class_Console.error(Effect_Class.monadEffectEffect)(Data_Show.show(Node_ChildProcess.showExit)(code))();
                      Effect_Class_Console.error(Effect_Class.monadEffectEffect)(v5)();
                      return cb(Data_Either.Left.create(Effect_Exception.error(v5)))();
                  };
              })();
              return Effect_Aff.effectCanceler(Data_Functor["void"](Effect.functorEffect)(Node_ChildProcess.kill(Data_Posix_Signal.SIGTERM.value)(v3)));
          };
      });
  };
  ...
  var mkJSONError = function ($109) {
      return JSONError.create(Simple_JSON_Utils.printMultipleErrors($109));
  };
  var readPackage = (function () {
      var $110 = Data_Bifunctor.lmap(Data_Either.bifunctorEither)(mkJSONError);
      var $111 = Simple_JSON.readJSON(Simple_JSON.readRecord()(Simple_JSON.readFieldsCons(new Data_Symbol.IsSymbol(function () {
          return "packageName";
      }))(Simple_JSON.readString)(Simple_JSON.readFieldsCons(new Data_Symbol.IsSymbol(function () {
          return "repo";
  ...
  var genericRepo = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Core (line 182, column 1 - line 182, column 46): " + [ x.constructor.name ]);
  }, function (x) {
  ...
  var genericMyError = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Core (line 140, column 1 - line 140, column 52): " + [ x.constructor.name ]);
  }, function (x) {
      if (x instanceof Data_Generic_Rep.Inl) {
  ...
  var genericFetchResult = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Core (line 185, column 1 - line 185, column 60): " + [ x.constructor.name ]);
  }, function (x) {
      if (x instanceof Data_Generic_Rep.Inl) {
  ...
  var readForeignFetchResult = new Simple_JSON.ReadForeign((function () {
      var $113 = Data_Functor.map(Control_Monad_Except_Trans.functorExceptT(Data_Identity.functorIdentity))(Kishimen.variantToGenericSum(genericFetchResult)(Kishimen.genericSumToVariantSum(Kishimen.genericSumToVariantConstructor(new Data_Symbol.IsSymbol(function () {
          return "CantFetchLocal";
      ...
      var $114 = Simple_JSON.readImpl(Simple_JSON.readForeignVariant()(Simple_JSON.readVariantCons(new Data_Symbol.IsSymbol(function () {
          return "CantFetchLocal";
  ...
  var writeForeignFetchResult = new Simple_JSON.WriteForeign((function () {
      var $116 = Simple_JSON.writeImpl(Simple_JSON.writeForeignVariant()(Simple_JSON.consWriteForeignVariant(new Data_Symbol.IsSymbol(function () {
          return "CantFetchLocal";
      ...
      var $117 = Kishimen.genericSumToVariant(genericFetchResult)(Kishimen.genericSumToVariantSum(Kishimen.genericSumToVariantConstructor(new Data_Symbol.IsSymbol(function () {
          return "CantFetchLocal";
      }))()(Kishimen.genericSumToVariantArgArguments))(Kishimen.genericSumToVariantConstructor(new Data_Symbol.IsSymbol(function () {
          return "Fetched";
      }))()(Kishimen.genericSumToVariantArgArguments))()()()()(Data_Variant_Internal.variantTagsCons(Data_Variant_Internal.variantTagsNil)(new Data_Symbol.IsSymbol(function () {
  ...
  var exit = (function () {
      var $119 = Effect_Class.liftEffect(Effect_Aff.monadEffectAff);
      return function ($120) {
          return $119($foreign["_exit"]($120));
      };
  })();
                  ...
                  return function (options) {
                      return Effect_Aff.makeAff(function (cb) {
                          return function __do() {
                              ...
                              var v1 = Effect_Ref["new"]("")();
                              var v2 = Node_ChildProcess.spawn(cmd)(args)(options)();
                              Node_Stream.onDataString(Node_ChildProcess.stdout(v2))(encoding)(function (string) {
                                  return Effect_Ref.modify_(function (v3) {
                                      return v3 + string;
                                  })(v);
                              })();
                              Node_Stream.onDataString(Node_ChildProcess.stderr(v2))(encoding)(function (string) {
                                  return Effect_Ref.modify_(function (v3) {
                                      return v3 + string;
                                  })(v1);
                              })();
                              Node_ChildProcess.onError(v2)(function ($12) {
                                  return cb(Data_Either.Left.create(Node_ChildProcess.toStandardError($12)));
                              })();
                              Node_ChildProcess.onExit(v2)(function (exit) {
                                  return function __do() {
                              ...
                              return Effect_Aff.effectCanceler(Data_Functor["void"](Effect.functorEffect)(Node_ChildProcess.kill(killSignal)(v2)));
                          };
                      });
                  };
              };
...
(function($PS) {
  ...
  var spagoListPackages = (function () {
      ...
      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class_Console.error(Effect_Aff.monadEffectAff)("getting packages.."))(function () {
          return Control_Bind.bind(Effect_Aff.bindAff)(Sunde.spawn("spago")([ "list-packages", "-f", "transitive", "-j" ])(Node_ChildProcess.defaultSpawnOptions))(function (v) {
  ...
  var printResult = function (v) {
      ...
      throw new Error("Failed pattern match at Generate (line 171, column 1 - line 171, column 37): " + [ v.constructor.name ]);
  };
  ...
  var fetchPackage = function (v) {
      ...
      if (v.repo instanceof Core.Remote) {
          return Control_Monad_Except_Trans.runExceptT(Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff))(Control_Monad_Trans_Class.lift(Control_Monad_Except_Trans.monadTransExceptT)(Effect_Aff.monadAff)(Sunde.spawn("nix-prefetch-git")([ v.repo.value0, "--rev", v.version, "--quiet" ])(Node_ChildProcess.defaultSpawnOptions)))(function (v1) {
              return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff))((function () {
                  ...
                  return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff))((function () {
                      ...
                      throw new Error("Failed pattern match at Generate (line 81, column 37 - line 83, column 88): " + [ v3.constructor.name ]);
                  })())(function (v3) {
      ...
      throw new Error("Failed pattern match at Generate (line 64, column 1 - line 64, column 60): " + [ v.constructor.name ]);
  };
      ...
      return Control_Bind.bind(Effect_Aff.bindAff)(Node_FS_Aff.exists(path))(function (v) {
          if (v) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class_Console.error(Effect_Aff.monadEffectAff)("already prefetched " + p.packageName))(function () {
                  return Control_Bind.bind(Effect_Aff.bindAff)(Node_FS_Aff.readTextFile(Node_Encoding.UTF8.value)(path))(function (v1) {
                      ...
                      throw new Error("Failed pattern match at Generate (line 96, column 7 - line 98, column 85): " + [ v2.constructor.name ]);
                  });
              });
          };
          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class_Console.error(Effect_Aff.monadEffectAff)("fetching " + p.packageName))(function () {
              return Control_Bind.bind(Effect_Aff.bindAff)(fetchPackage(p))(function (v1) {
                  ...
                  throw new Error("Failed pattern match at Generate (line 102, column 7 - line 106, column 22): " + [ v1.constructor.name ]);
              });
          });
      });
  };
  var generate = (function () {
      ...
      var exitOnError = function (aff) {
          return Control_Bind.bind(Effect_Aff.bindAff)(aff)(function (v) {
              ...
              throw new Error("Failed pattern match at Generate (line 227, column 7 - line 231, column 17): " + [ v.constructor.name ]);
          });
      };
      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(ensureSetup)(function () {
          return Control_Bind.bind(Effect_Aff.bindAff)(exitOnError(spagoListPackages))(function (v) {
              return Control_Bind.bind(Effect_Aff.bindAff)(Data_Functor.map(Effect_Aff.functorAff)(toResult)(Control_Parallel.parTraverse(Effect_Aff.parallelAff)(Data_Traversable.traversableArray)(ensureFetchPackage)(v)))(function (v1) {
                  ...
                  throw new Error("Failed pattern match at Generate (line 210, column 3 - line 218, column 13): " + [ v1.constructor.name ]);
              });
          });
      });
  })();
...
(function($PS) {
  ...
  var build = function (extraArgs) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Core.buildScript(Data_List_Types.foldableList)({
          ...
          return Control_Bind.bind(Effect_Aff.bindAff)(Core.runDhallToJSON("(./spago.dhall).sources"))(function (v) {
              return Control_Bind.bind(Effect_Aff.bindAff)((function () {
                  ...
                  throw new Error("Failed pattern match at Main (line 45, column 12 - line 53, column 14): " + [ v1.constructor.name ]);
              })())(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Core.runCommand({
                      cmd: "bash",
