...
(function($PS) {
  ...
  var writeForeignRepo = new Simple_JSON.WriteForeign(function (v) {
      ...
      throw new Error("Failed pattern match at Core (line 87, column 1 - line 89, column 84): " + [ v.constructor.name ]);
  });
  ...
  var mkJSONError = function ($77) {
      return JSONError.create(Simple_JSON_Utils.printMultipleErrors($77));
  };
  var readPackage = (function () {
      var $78 = Data_Bifunctor.lmap(Data_Either.bifunctorEither)(mkJSONError);
      var $79 = Simple_JSON.readJSON(Simple_JSON.readRecord()(Simple_JSON.readFieldsCons(new Data_Symbol.IsSymbol(function () {
          return "packageName";
      }))(Simple_JSON.readString)(Simple_JSON.readFieldsCons(new Data_Symbol.IsSymbol(function () {
          return "repo";
  ...
  var genericRepo = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Core (line 108, column 1 - line 108, column 46): " + [ x.constructor.name ]);
  }, function (x) {
  ...
  var genericMyError = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Core (line 66, column 1 - line 66, column 52): " + [ x.constructor.name ]);
  }, function (x) {
      if (x instanceof Data_Generic_Rep.Inl) {
  ...
  var genericFetchResult = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Core (line 111, column 1 - line 111, column 60): " + [ x.constructor.name ]);
  }, function (x) {
      if (x instanceof Data_Generic_Rep.Inl) {
  ...
  var readForeignFetchResult = new Simple_JSON.ReadForeign((function () {
      var $81 = Data_Functor.map(Control_Monad_Except_Trans.functorExceptT(Data_Identity.functorIdentity))(Kishimen.variantToGenericSum(genericFetchResult)(Kishimen.genericSumToVariantSum(Kishimen.genericSumToVariantConstructor(new Data_Symbol.IsSymbol(function () {
          return "CantFetchLocal";
      ...
      var $82 = Simple_JSON.readImpl(Simple_JSON.readForeignVariant()(Simple_JSON.readVariantCons(new Data_Symbol.IsSymbol(function () {
          return "CantFetchLocal";
  ...
  var writeForeignFetchResult = new Simple_JSON.WriteForeign((function () {
      var $84 = Simple_JSON.writeImpl(Simple_JSON.writeForeignVariant()(Simple_JSON.consWriteForeignVariant(new Data_Symbol.IsSymbol(function () {
          return "CantFetchLocal";
      ...
      var $85 = Kishimen.genericSumToVariant(genericFetchResult)(Kishimen.genericSumToVariantSum(Kishimen.genericSumToVariantConstructor(new Data_Symbol.IsSymbol(function () {
          return "CantFetchLocal";
      }))()(Kishimen.genericSumToVariantArgArguments))(Kishimen.genericSumToVariantConstructor(new Data_Symbol.IsSymbol(function () {
          return "Fetched";
      }))()(Kishimen.genericSumToVariantArgArguments))()()()()(Data_Variant_Internal.variantTagsCons(Data_Variant_Internal.variantTagsNil)(new Data_Symbol.IsSymbol(function () {
  ...
  var exit = (function () {
      var $87 = Effect_Class.liftEffect(Effect_Aff.monadEffectAff);
      return function ($88) {
          return $87($foreign["_exit"]($88));
      };
  })();
...
(function($PS) {
  ...
  var printResult = function (v) {
      ...
      throw new Error("Failed pattern match at Generate (line 156, column 1 - line 156, column 37): " + [ v.constructor.name ]);
  };
  ...
  var generate = (function () {
      ...
      var exitOnError = function (aff) {
          return Control_Bind.bind(Effect_Aff.bindAff)(aff)(function (v) {
              ...
              throw new Error("Failed pattern match at Generate (line 212, column 7 - line 216, column 17): " + [ v.constructor.name ]);
          });
      };
      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(ensureSetup)(function () {
          return Control_Bind.bind(Effect_Aff.bindAff)(exitOnError(spagoListPackages))(function (v) {
              return Control_Bind.bind(Effect_Aff.bindAff)(Data_Functor.map(Effect_Aff.functorAff)(toResult)(Control_Parallel.parTraverse(Effect_Aff.parallelAff)(Data_Traversable.traversableArray)(ensureFetchPackage)(v)))(function (v1) {
                  ...
                  throw new Error("Failed pattern match at Generate (line 195, column 3 - line 203, column 13): " + [ v1.constructor.name ]);
              });
          });
      });
  })();
...
(function($PS) {
  ...
  var install = function (extraArgs) {
      var spawnArgs = Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Core.spagoPackagesNix, "-A", "installSpagoStyle", "--run", "exit" ])(Data_Array.fromFoldable(Data_List_Types.foldableList)(extraArgs));
      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class_Console.log(Effect_Aff.monadEffectAff)("installing..."))(function () {
          return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Node_ChildProcess.spawn("nix-shell")(spawnArgs)({
              ...
              return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Node_ChildProcess.onExit(v)(function (v1) {
                  return function __do() {
                      Effect_Class_Console.log(Effect_Class.monadEffectEffect)("done")();
                      return Core["_exit"](0)();
                  };
              }));
          });
  ...
  var help = "\x0aspago2nix - generate Nix derivations from packages required in a spago project, and allow for installing them and building them.\x0a\x0a  Usage: spago2nix (generate | install)\x0a\x0aAvailable commands:\x0a  generate\x0a    Generate a Nix expression of packages from Spago\x0a  install [passthrough args for nix-shell]\x0a    Install dependencies from spago-packages.nix in Spago style\x0a";
